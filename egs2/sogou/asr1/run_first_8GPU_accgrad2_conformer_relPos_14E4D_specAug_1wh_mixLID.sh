...
asr_config=conf/train_asr_conformer_relPos_first_8GPU_accgrad2_14E4D_specAug_1wh.yaml
...
./asr_first_8GPU_accgrad2_conformer_relPos_14E4D_specAug_1wh_mixLID.sh              \
    --audio_format wav                                 \
