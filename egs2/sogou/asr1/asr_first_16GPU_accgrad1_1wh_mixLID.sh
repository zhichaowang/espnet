...
# ASR model related
asr_tag=transformer_1wh_mixLID_16GPU    # Suffix to the result dir for asr model training.
...
#            utils/copy_data_dir.sh data/"${dset}" "${data_feats}/org/${dset}"
             cp data/"${dset}" "${data_feats}/org/${dset}" -r
...
#        utils/copy_data_dir.sh "${data_feats}/org/${dset}" "${data_feats}/${dset}"
        cp "${data_feats}/org/${dset}" "${data_feats}/${dset}" -r
