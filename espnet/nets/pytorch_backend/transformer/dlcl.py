...
# encoding: utf-8
"""
@author: Wang Qiang, Wang Zhichao
...
class DynamicLinearCombination(nn.Module):
    ...
    def __init__(self, 
                 ...
                 normalize_before,
                 weight_type="scalar",
                 normalize_learned_weight=False,
                 normalize_embed=False):
        super(DynamicLinearCombination, self).__init__()
        self.dim = dim
        self.normalize_learned_weight = normalize_learned_weight
        ...
        # num_block + 1
        layer_num = 1 + num_blocks

        # init weights and corresponding masks
        self.weight, self.weight_mask = self._init(layer_num,
                                                   init_value,
                                                   history_window_size)
    ...
    def _init(self, layer_num, init_value, window_size=-1, learnable=True):
        """
