...
train_config=conf/tuning/train_pytorch_transformer_1wh_LR0.0003_0.00003_atten512.yaml
lm_config=conf/lm.yaml
decode_config=conf/decode.yaml

# rnnlm related
lm_resume=         # specify a snapshot file to resume LM training
lmtag=1wh             # tag for managing LMs
...
# exp tag
tag="LR0.0003_0.00003_atten512" # tag for managing experiments.
...
train_set=train_sogou_fbank_1wh_chn_nodev_nodup
train_dev=train_sogou_fbank_1wh_chn_dev_100h
recog_set="test8000_sogou"
...
dict=data/lang_1char/chn_units.txt
