...
train_config=conf/tuning/train_pytorch_transformer_noCTC.yaml
lm_config=conf/lm.yaml
decode_config=conf/tuning/decode_pytorch_transformer_noCTC.yaml
...
# exp tag
tag="noCTC" # tag for managing experiments.
