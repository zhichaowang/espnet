...
train_config=conf/tuning/train_pytorch_transformer_CTC.yaml
lm_config=conf/lm.yaml
decode_config=conf/tuning/decode_pytorch_transformer_CTC.yaml
...
# exp tag
tag="CTC" # tag for managing experiments.
