...
train_config=conf/tuning/train_pytorch_transformer_noLableSmooth.yaml
lm_config=conf/lm.yaml
decode_config=conf/tuning/decode_pytorch_transformer_streaming.yaml

# rnnlm related
lm_resume=         # specify a snapshot file to resume LM training
lmtag=500h             # tag for managing LMs
...
# exp tag
tag="noLabelSmooth" # tag for managing experiments.
